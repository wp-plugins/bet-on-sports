...
/*
  ...
  Description: Таблицы, ставки на спорт, прогнозы. Два виджета, верхний и боковой, где выводятся коэфициенты ставок букмекерской конторы bet at home, посетители на вашем сайте смогут делать сразу ставки! Партнерскую ссылку можно менять, можно выводить разные виды спорта.
  Version: 1.2
  Author: SEOAlbion
