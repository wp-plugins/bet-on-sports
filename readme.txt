...
после нужно вывести установленный  виджет в созданном сайдбаре. Это можно сделать  админ панели на странице виджетов
...
после нужно вывести установленный виджет в созданом сайдбаре . В админ панели на странице виджетов просто перетаскиваем нужный нам виджет,  в созданный нами сайдбар. 
