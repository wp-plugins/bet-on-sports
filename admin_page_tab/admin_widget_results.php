...
<!--			<p>
			...
			<p>
				...
				<input style="width: 100%;" id="BW_link" type="text" autocomplete="off" value="<?php echo get_option('bw_link_sport'); ?>" size="30" name="bw_link_sport">
				<br/><br/>
	...
	if (isset( $_GET['results_button'] ) && $_GET['results_button'] == 'update') {
		update_option('bw_link_sport', $_POST['bw_link_sport']);
